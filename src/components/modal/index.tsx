    ...
    <div className="modal-dialog modal-lg" onClick={onClickModal}>
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">书籍信息</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="关闭" onClick={onClickClose}></button>
        </div>
        <div className="modal-body" onClick={onClickModalBody}>
          <div className="mb-3 row">
            <label htmlFor="input-filename" className="col-sm-2 col-form-label text-end">文件名</label>
          ...
          <div className="mb-3 row">
            <label htmlFor="input-book-title" className="col-sm-2 col-form-label text-end">标题</label>
            <div className="col-sm-10">
          ...
          <div className="mb-3 row">
            <label htmlFor="input-book-author" className="col-sm-2 col-form-label text-end">作者</label>
            <div className="col-sm-10">
              {
          ...
          <div className="mb-3 row">
            <label htmlFor="input-book-subject" className="col-sm-2 col-form-label text-end">分类</label>
            <div className="col-sm-10">
          ...
          <div className="mb-3 row">
            <label htmlFor="input-book-publisher" className="col-sm-2 col-form-label text-end">出版社</label>
            <div className="col-sm-10">
        ...
        <div className="modal-footer justify-content-start">
          <button type="button" className="btn btn-sm btn-outline-primary" onClick={onClickSaveSet}>保存预设</button>
          <select className="form-select form-select-sm" value={selectedSetIndex + ''} defaultChecked={false} ref={setsSeletRef} style={{width: '200px'}} onChange={onApplySet}>
            {
              storeBook.savedSets.map((set, index) =>
                <option defaultChecked={false} key={index} value={index}>标题: {set.bookTitle}, 作者: {set.bookAuthors[0]}, 分类: {set.bookSubject}</option>
              )
            }
          </select>
          <button type="button" disabled={selectedSetIndex === -1} className="btn btn-sm btn-outline-danger" onClick={onClickRemoveSet}>删除预设</button>
        </div>
      </div>
    </div>
  )
...
const ModalContents = observer(function() {
  ...
  return (
    <div className="modal-dialog modal-lg" onClick={onClickModal}>
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">目录</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="关闭" onClick={onClickClose}></button>
        </div>
        <div className="modal-body" onClick={onClickModalBody}>
          {
                    ...
                    <div className={'row mb-' + (index === maxIndex ? '2' : '4')} key={index}>
                      ...
                      <div className="col-auto">
                        <div className="btn-group" role="group" aria-label="操作">
                          <button type="button" className="btn btn btn-secondary d-flex justify-content-center align-items-center" data-index={index} onClick={onClickAdd} title="添加">
                            <Icon name="plus"></Icon>
                          </button>
                          <button type="button" className="btn btn btn-secondary d-flex justify-content-center align-items-center" data-index={index} onClick={onClickRemove} title="删除">
                            <Icon name="minus"></Icon>
                          </button>
                        </div>
                      </div>
...
const ModalPage = observer(function() {
  ...
  return (
    <div className="modal-dialog modal-md" onClick={onClickModal}>
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title">页面设置</h5>
          <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="关闭" onClick={onClickClose}></button>
        </div>
        <div className="modal-body">
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">尺寸</label>
            <div className="col-9 d-flex align-items-center">
              <div className="row justify-content-between">
                <div className="col-5 d-flex align-items-center">
                  <div className="input-group input-group-sm">
                    <span className="input-group-text">宽</span>
                    <input
                      type="number"
                      className="form-control"
                      min="1"
                ...
                <div className="col-2 d-flex justify-content-center">
                  <button type="button" className="btn btn-sm btn-secondary d-flex justify-content-center align-items-center" onClick={onSwitchPageSize} title="交换宽高">
                    <Icon name="cycle"/>
                  </button>
                </div>
                <div className="col-5 d-flex align-items-center">
                  <div className="input-group input-group-sm">
                    <span className="input-group-text">高</span>
                    <input
                      type="number"
                      className="form-control"
                      min="1"
          ...
          <div className="mb-2 row">
            <label htmlFor="input-page-position" className="col-3 col-form-label text-end">位置</label>
            <div className="col-9 d-flex align-items-center">
              <ButtonRadio current={storeBook.pagePosition} value="center" label="居中" onClick={onChangePagePosition} />
              <ButtonRadio current={storeBook.pagePosition} value="between" label="两端对齐" onClick={onChangePagePosition} />
            </div>
          </div>
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">显示</label>
            <div className="col-9 d-flex align-items-center">
              <ButtonRadio current={storeBook.pageShow} value="two" label="双页" onClick={onChangePageShow} />
              <ButtonRadio current={storeBook.pageShow} value="one" label="单页" onClick={onChangePageShow} />
            </div>
          </div>
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">适配</label>
            <div className="col-9 d-flex align-items-center">
              <ButtonRadio current={storeBook.pageFit} value="stretch" label="拉伸" onClick={onChangePageFit} />
              <ButtonRadio current={storeBook.pageFit} value="fit" label="适应" onClick={onChangePageFit} />
              <ButtonRadio current={storeBook.pageFit} value="fill" label="填充" onClick={onChangePageFit} />
            </div>
          </div>
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">方向</label>
            <div className="col-9 d-flex align-items-center">
              <ButtonRadio current={storeBook.pageDirection} value="right" label="从右到左（日式）" onClick={onChangePageDirection} />
              <ButtonRadio current={storeBook.pageDirection} value="left" label="从左到右" onClick={onChangePageDirection} />
            </div>
          </div>
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">封面</label>
            <div className="col-9 d-flex align-items-center">
              <ButtonRadio current={storeBook.coverPosition} value="first-page" label="首页" onClick={onChangeCoverPosition} />
              <ButtonRadio current={storeBook.coverPosition} value="alone" label="独立" onClick={onChangeCoverPosition} />
            </div>
          </div>
          <div className="mb-2 row">
            <label className="col-3 col-form-label text-end">图片标签</label>
            <div className="col-9 d-flex align-items-center">
